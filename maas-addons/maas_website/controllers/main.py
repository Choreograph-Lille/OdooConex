...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; object-src 'self'; img-src 'self'; connect-src 'self' """ + '"{}"'.format(operation.pbi_function_app_url) + """;script-src 'self' 'nonce-script'; style-src 'self' 'nonce-style';">
    <meta charset="utf-8">
