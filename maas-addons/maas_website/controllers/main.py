...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; style-src 'self' 'sha256-tddwfqj8AKrkC/UArHSY1/Mvaxu/97T96XakA0XrX50=' https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css; script-src 'self' 'sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8=' https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js; object-src 'self'; img-src 'self'; connect-src 'self';">
    <meta charset="utf-8">
