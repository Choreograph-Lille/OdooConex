...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; object-src 'self'; img-src 'self'; connect-src 'self'; script-src-elem 'self' https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js;">
    <meta charset="utf-8">
