...
class SaleOrder(models.Model):
    ...
    def write(self, vals):
        ...
        for rec in self:
            ...
            if vals.get('repatriate_information') or ('segment_ids' in vals and self.repatriate_information) or ('quantity_to_deliver' in vals and self.repatriate_information):
