...
class ResPartner(models.Model):
    ...
    property_payment_term_id = fields.Many2one(tracking=10)
    property_product_pricelist = fields.Many2one(tracking=10)
    property_supplier_payment_term_id = fields.Many2one(tracking=10)
    property_purchase_currency_id = fields.Many2one(tracking=10)
    property_account_position_id = fields.Many2one(tracking=10)
    property_account_receivable_id = fields.Many2one(tracking=10)
    property_account_payable_id = fields.Many2one(tracking=10)
