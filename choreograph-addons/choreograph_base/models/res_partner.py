...
class ResPartner(models.Model):
    ...
    property_product_pricelist = fields.Many2one(comodel_name='product.pricelist', tracking=10, company_dependent=False)
    ...
    credit_limit = fields.Float(company_dependent=False)
